...
public class StatOutput implements StatOutputStrategy {
   ...
   */
  public StatOutput addOutputWriter(Consumer<String> outWriter) {
   ...
   */
  public StatOutput addOutputWriter(File outFile) {
   ...
   */
  public StatOutput addOutputWriter(File outFile, boolean append) {
   ...
   * {@link StatOutput#addOutputWriter}), there will be no output.
   *
